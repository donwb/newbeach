...
last_verified: 2026-09-26 (tvOS tide wave: high/low time captions + tomorrow dashed overlay committed, NOT yet flighted — see Recently shipped. API: evening-high warnings shipped — see Recently shipped. 2026-09-25: water-level anomaly shipped to the prediction model, params v7 — see Recently shipped. Earlier today: BUILD 1.4 (31) UPLOADED — iOS + tvOS on TestFlight, carrying
