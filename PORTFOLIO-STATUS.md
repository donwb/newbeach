...
app_review_state: |
  ...
  and 28 (1.1/1.2) CANNOT attach to the pending 1.0 submission. If 1.0 is left in the
  queue it ships the pre-parity, pre-rename build-18 app. Changing it to 1.2 means
  pulling from review and going to the back of the initial-review queue. Don's call —
  see open item 0.
