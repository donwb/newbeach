...
func TestBuildScorecardGradesTheDay(t *testing.T) {
	...
	sc := BuildScorecard(et(16, 0, 0), history, nil, testParams(), scorecardPreds())
...
func TestBuildScorecardMissAndFalseAlarm(t *testing.T) {
	...
	sc := BuildScorecard(et(16, 0, 0), history, nil, testParams(), preds)
...
func TestBuildScorecardMetadataOverride(t *testing.T) {
	...
	sc := BuildScorecard(et(16, 0, 0), history, heights, testParams(), scorecardPreds())
