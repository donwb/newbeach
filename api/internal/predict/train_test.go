...
func TestTrainLearnsSeparableThreshold(t *testing.T) {
	...
	params := Train(history, peaks, nil, et(15, 0, 0), nil)
...
func TestTrainSkipsSmallSamples(t *testing.T) {
	...
	params := Train(history, peaks, nil, et(3, 0, 0), nil)
...
func TestTrainNoisyDataStillReasonable(t *testing.T) {
	...
	params := Train(map[string][]models.StatusEvent{"DB-001": events}, peaks, nil, et(21, 0, 0), nil)
