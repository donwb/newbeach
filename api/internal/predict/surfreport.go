...
func BuildSurfReport(now time.Time, wave *models.WaveSample, cond *weather.Conditions, srf *weather.SurfZone) *SurfReport {
	...
	// No ramp-access clause (removed 2026-09-26): it truncated the tvOS surf
	// line, and the boards and outlook already carry closure risk.
	obs := wave.Time
	return &SurfReport{
		Line:        line,
		Quality:     quality,
