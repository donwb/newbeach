...
func TestWeekendMidweekHorizon(t *testing.T) {
	...
	out := BuildWeekendOutlook(now, testRamps(), weekendTestParams(), DefaultVerdictParams(), preds, land, nil, nil, nil)
...
func TestWeekendSaturdayAfternoonAndRollover(t *testing.T) {
	...
	out := BuildWeekendOutlook(satPM, testRamps(), weekendTestParams(), DefaultVerdictParams(), preds, land, nil, nil, nil)
	...
	out = BuildWeekendOutlook(satNight, testRamps(), weekendTestParams(), DefaultVerdictParams(), preds, land, nil, nil, nil)
	require.NotEmpty(t, out.Days)
...
func TestWeekendTideOnlyDegradation(t *testing.T) {
	...
	out := BuildWeekendOutlook(now, testRamps(), weekendTestParams(), DefaultVerdictParams(), preds, nil, nil, nil, nil)
...
func TestWeekendWhySilentWhenHeadlineCovers(t *testing.T) {
	...
	quiet := BuildWeekendOutlook(now, testRamps(), weekendTestParams(), DefaultVerdictParams(), preds, flatLand(now, now.AddDate(0, 0, 7), nil), nil, nil, nil)
...
func TestWeekendVerdictParamsOverride(t *testing.T) {
	...
	vp.GustToughMph = 40
	out := BuildWeekendOutlook(now, testRamps(), weekendTestParams(), vp, preds, land, nil, nil, nil)
	sat := day(t, out, "Saturday")
	require.NotNil(t, sat)
...
func TestWeekendCopyRules(t *testing.T) {
	...
	scenarios := []WeekendOutlook{
		BuildWeekendOutlook(now, testRamps(), weekendTestParams(), DefaultVerdictParams(), preds, land, nil, nil, nil),
		BuildWeekendOutlook(now, testRamps(), weekendTestParams(), DefaultVerdictParams(), preds, nil, nil, nil, nil),
	}
	...
	scenarios = append(scenarios, BuildWeekendOutlook(now, testRamps(), weekendTestParams(), DefaultVerdictParams(), preds, stormy, nil, nil, nil))
...
func TestWeekendClosureRiskLabel(t *testing.T) {
	...
	build := func() WeekendOutlook {
		return BuildWeekendOutlook(now, testRamps(), weekendTestParams(), DefaultVerdictParams(), preds, land, nil, nil, nil)
	}
...
func TestWeekendSurfLabel(t *testing.T) {
	...
	out = BuildWeekendOutlook(now, testRamps(), weekendTestParams(), DefaultVerdictParams(), preds, land, marine, nil, nil)
